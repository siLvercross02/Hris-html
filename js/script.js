...
function toggleSub() {
    document.getElementById('arrow-down').classList.toggle("d-inline");
    document.getElementById('right-arrow').classList.toggle("d-none");
}

function toggleApproval() {
    document.getElementById('down-approval').classList.toggle("d-inline");
    document.getElementById('right-approval').classList.toggle("d-none");
}
